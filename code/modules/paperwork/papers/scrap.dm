...
/obj/item/paper/heartfelt/Initialize()
	var/static/list/info = list(
		"Negotiate trade agreements with merchants in Stonekeep to facilitate the exchange of goods and resources between the two realms.",
		"Explore the mysteries of the Isle of Enigma, uncovering its secrets and hidden treasures.",
		"Establish a diplomatic alliance with the Monarch of Stonekeep to strengthen the relationship between Heartfelt and Stonekeep.",
